...
#define	COLLISION_FILTER_PICKUP		0x00000001
#define	COLLISION_FILTER_VEHICLE	0x00000002
#define	COLLISION_FILTER_MISSILE	0x00000004
#define	COLLISION_FILTER_MINE		0x00000008
